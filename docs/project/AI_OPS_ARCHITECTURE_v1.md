...
状態: **v1.0 / 凍結（FROZEN 2026-07-02）** — 設計はここで固定。以後は実運用で検証し、改善は日々変更せず `AI_OPS_BACKLOG.md` に蓄積して v1.1 でまとめて反映する。**設計を毎日変更しない。**
次回設計レビュー条件（いずれか）：1週間連続運用 / 50 Issue処理 / 20 PR作成 / 重大障害 / AI構成変更 / 運用コストが想定±20%乖離。
